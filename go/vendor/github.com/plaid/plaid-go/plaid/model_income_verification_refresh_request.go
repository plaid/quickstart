...
func NewIncomeVerificationRefreshRequest() *IncomeVerificationRefreshRequest {
	this := IncomeVerificationRefreshRequest{}
	return &this
}
...
type NullableIncomeVerificationRefreshRequest struct {
	value *IncomeVerificationRefreshRequest
	isSet bool
}

func (v NullableIncomeVerificationRefreshRequest) Get() *IncomeVerificationRefreshRequest {
	return v.value
}

func (v *NullableIncomeVerificationRefreshRequest) Set(val *IncomeVerificationRefreshRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableIncomeVerificationRefreshRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableIncomeVerificationRefreshRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIncomeVerificationRefreshRequest(val *IncomeVerificationRefreshRequest) *NullableIncomeVerificationRefreshRequest {
	return &NullableIncomeVerificationRefreshRequest{value: val, isSet: true}
}

func (v NullableIncomeVerificationRefreshRequest) MarshalJSON() ([]byte, error) {
