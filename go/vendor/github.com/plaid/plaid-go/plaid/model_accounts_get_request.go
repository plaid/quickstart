...
func (o *AccountsGetRequest) GetOptions() AccountsGetRequestOptions {
	if o == nil || o.Options == nil {
		var ret AccountsGetRequestOptions
		return ret
	}
	return *o.Options
}
...
type NullableAccountsGetRequest struct {
	value *AccountsGetRequest
	isSet bool
}

func (v NullableAccountsGetRequest) Get() *AccountsGetRequest {
	return v.value
}

func (v *NullableAccountsGetRequest) Set(val *AccountsGetRequest) {
	v.value = val
	v.isSet = true
}
...
func NewNullableAccountsGetRequest(val *AccountsGetRequest) *NullableAccountsGetRequest {
	return &NullableAccountsGetRequest{value: val, isSet: true}
}
